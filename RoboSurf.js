...
return "ISF ratio: " + round(new_autosens_ratio, 2) + ". ISF was: " + round(isf, 2) + " now " + round(profile.sens,2) + " RoboSens Ratio: " + round(robosens_sigmoidFactor, 2) + " Basal was: " + old_basal + " now " + profile.current_basal +". SMB Deliv. Ratio: " + profile.smb_delivery_ratio + " AUTOMATION1: " + Automation_Status + " [Start: " + start_time.toLocaleTimeString([],{hour: '2-digit', minute:'2-digit'}) + " End: " + end_time.toLocaleTimeString([],{hour: '2-digit', minute:'2-digit'}) + " ATM1 CR: "  + round(profile.carb_ratio, 2) + " CSF was: "  + round(csf, 2) + " now: " + round(check_csf, 2) + " New SMB Mins: "  + round(profile.maxSMBBasalMinutes, 2) + " New UAM Mins: "  + round(profile.maxUAMSMBBasalMinutes, 2) + " New MaxCOB: "  + round(profile.maxCOB, 2) + " MinAbsorp((CI): "  + round(min_hourly_carb_absorption, 2) + "(" + profile.min_5m_carbimpact + ")" + " ROBOSENS: Trg/Av/%Over: 4Hr: " + target_averageGlucose_Last4Hours + "/" + round(averageGlucose_Last4Hours, 0) + "/" + round(percentageOverTarget_Last4Hours, 0) + "%" + 
" 8Hr:" + target_averageGlucose_Last8Hours + "/" + round(averageGlucose_Last8Hours, 0) + "/" + round(percentageOverTarget_Last8Hours, 0) + "%" + 
" 24Hr:" + target_averageGlucose_Last24Hours + "/" + round(averageGlucose_Last24Hours, 0) + "/" + round(percentageOverTarget_Last24Hours, 0) + "%" + " RS Protect: " + robosens_sens_protect + " RS Adj/AF: " + robosens_AF_adjustment + "/" + robosens_adjustmentFactor + " RS Adj/MAX: " + robosens_MAX_adjustment + "/" + robosens_maximumRatio + " TDD-SensProtect: " + log_protectionmechanism + " TDD:" + round(past2hoursAverage, 2) + " 2week TDD:" + round(average_total_data, 2) + " Wtd Avg:" + round(weightedAverage, 2);
   }
}
