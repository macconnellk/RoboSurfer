...
return "ISF ratio: " + round(new_autosens_ratio, 2) + ". ISF was: " + round(isf, 2) + " now " + round(profile.sens,2) + ". SMB Deliv. Ratio: " + profile.smb_delivery_ratio + ". SensProtect: " + log_protectionmechanism + " AUTOMATION: " + Automation_Status + ". Start: " + start_time.toLocaleTimeString([],{hour: '2-digit', minute:'2-digit'}) + " End: " + end_time.toLocaleTimeString([],{hour: '2-digit', minute:'2-digit'}) + " Autom ISF: "  + round(profile.sens, 2) + " Autom. CR: "  + round(profile.carb_ratio, 2) + " Profile CSF: "  + round(csf, 2) + " Autom. CSF: " + round(check_csf, 2) + " SMB Mins: "  + round(profile.maxSMBBasalMinutes, 2) + " UAM Mins: "  + round(profile.maxUAMSMBBasalMinutes, 2) + " MaxCOB: "  + round(profile.maxCOB, 2) + " MinAbsorp((CI): "  + round(min_hourly_carb_absorption, 2) + "(" + profile.min_5m_carbimpact + ")" + " ROBOSENS: Tr/Av/%Ov: 4Hr: " + target_averageGlucose_Last4Hours + "/" + round(averageGlucose_Last4Hours, 0) + "/" + round(percentageOverTarget_Last4Hours, 0) + "%" + 
" 8Hr:" + target_averageGlucose_Last8Hours + "/" + round(averageGlucose_Last8Hours, 0) + "/" + round(percentageOverTarget_Last8Hours, 0) + "%" + 
" 24Hr:" + target_averageGlucose_Last24Hours + "/" + round(averageGlucose_Last24Hours, 0) + "/" + round(percentageOverTarget_Last24Hours, 0) + "%" + " RS Ratio: " + round(robosens_sigmoidFactor, 2) + "Prof. Basal: " + old_basal + " RS Basal: " + profile.current_basal + " RS Protect: " + robosens_sens_protect + " RS Adj/AF: " + robosens_AF_adjustment + "/" + robosens_adjustmentFactor + " RS Adj/MAX: " + robosens_MAX_adjustment + "/" + robosens_maximumRatio + " TDD:" + round(past2hoursAverage, 2) + " 2week TDD:" + round(average_total_data, 2) + " Wtd Avg:" + round(weightedAverage, 2);
   }
}
